...
describe('Main Page -> About Me', () => {
	...
	it('Verify Resume is the latest version', () => {
		cy.get('.resume').should('have.attr','id','11-20-2020')
	})
})
...
describe('Navigation Tests', () => {
	...
	it('Verify href attributes for Personal Projects are correct', () => {
		cy.get('.personalwebsite-demo').should('have.attr','href','images/gifs/DavidDicioco_PersonalWebsite_spec.js.gif')
		cy.get('.weather-app').should('have.attr','href','projects\\WeatherApp\\index.html')		
	})
})
